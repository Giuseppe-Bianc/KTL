...
sealed class Token(open val type: String, open val line: Int, open val column: Int) {
    ...
    data class Identifier(val name: String, override val line: Int, override val column: Int) : Token("Identifier", line, column) {
        override fun toString(): String ="Identifier(name='$name', line=$line, column=$column)"
    }
    data class KeyWord(val name: String, override val line: Int, override val column: Int) : Token("keyWord", line, column) {
        override fun toString(): String ="KeyWord(name='$name', line=$line, column=$column)"
    }

    data class STRING(val name: String, override val line: Int, override val column: Int) : Token("keyWord", line, column) {
